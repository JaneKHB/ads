...
FILE_LOG_LIPLUS_GET_PATH = FILE_LOG_PATH + 'liplus_get%s.log'
FILE_LOG_LIPLUS_TRANSFER_PATH = FILE_LOG_PATH + 'liplus_transfer%s.log'
FILE_LOG_LIPLUS_DOWNLOAD_PATH = FILE_LOG_PATH + 'liplus_download.log'
FILE_LOG_LIPLUS_UPLOAD_PATH = FILE_LOG_PATH + 'liplus_upload.log'
